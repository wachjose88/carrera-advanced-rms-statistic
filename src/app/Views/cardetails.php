        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <img src="<?= base_url('uploads/cars/' . esc($image)) ?>" alt="<?= esc($title) ?>" class="img-fluid">
                    <br><br><a href="<?= base_url('cars/delete/' . esc($car['id'])) ?>" class="btn btn-primary">
                        <?= lang('carrera.delete') ?>
                    </a>
                    <?php else: ?>
                        <form method="post" action="<?= base_url('cars/details/' . esc($car['id'])) ?>" enctype="multipart/form-data">
                            <?php if (isset($error)): ?>
                ...
                <div class="card-body">
                    <ul>
                        ...
                        <li><?= lang('carrera.bestlap') ?>
                            <ul>
                                <li><?= esc($statistic['bestlap']) ?> s</li>
                                <li><?= lang('carrera.speedreal') ?>: <?= esc($bestlaprealspeed) ?> km/h</li>
                                <li><?= lang('carrera.speedscaled') ?>: <?= esc($bestlapscaledspeed) ?> km/h</li>
                            </ul>
                        </li>
                        <?php if (!is_null($car['tires'])): ?>
                        <li><?= lang('carrera.tires') ?>:
                            <?= esc($car['tires']) ?></li>
                        <?php endif; ?>
                        <?php if ($car['scale'] != 0 && !is_null($car['scale'])): ?>
                        <li><?= lang('carrera.scale') ?>:
                            1:<?= esc($car['scale']) ?></li>
                        <?php endif; ?>
                    </ul>
                </div>
